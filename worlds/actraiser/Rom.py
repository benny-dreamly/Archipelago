...
def patch_rom(world: World, rom: LocalRom):
    ...
    rom.write_bytes(0xF81B0, bytearray([
        ...
        0xCD, 0x06, 0x80, 	#	CMP $8004
        0x90, 0x0A, 	#	BCC return
    ...
    rom.write_bytes(0x6BC80, bytearray([
        0x00, 0x00, 0x03, 0x7F, 0x07, 0x7F, 0x3F, 0x79, 0x7F, 0x7C, 0x79, 0x7E, 0x41, 0x7E, 0x18, 0x67,
        0xFF, 0x00, 0xFC, 0x7F, 0xF8, 0x7F, 0xC0, 0x41, 0xB8, 0x00, 0xFA, 0x06, 0xC6, 0x3E, 0xA7, 0x67,
        0x00, 0x00, 0xC0, 0xFE, 0xE0, 0xFE, 0xE0, 0x9E, 0xDC, 0x3E, 0xBE, 0x7E, 0x9E, 0x7E, 0x1A, 0xE6,
        0xFF, 0x00, 0x3F, 0xFE, 0x1F, 0xFE, 0x03, 0x82, 0x01, 0x00, 0x61, 0x60, 0x7D, 0x7C, 0xFF, 0xE6,
    ]))
    #AP Icon Bottom Tiles
    rom.write_bytes(0x6BE80, bytearray([
        0x24, 0x43, 0x45, 0x02, 0x0E, 0x00, 0x04, 0x08, 0x00, 0x48, 0x00, 0x7C, 0x00, 0x7E, 0x00, 0x00,
        0xDB, 0x43, 0xBA, 0x03, 0xF0, 0x07, 0xF8, 0x0F, 0xF8, 0x4F, 0xFC, 0x7F, 0xFE, 0x7F, 0xFF, 0x00,
        0x24, 0xDA, 0x82, 0x7C, 0x60, 0x1E, 0x20, 0x1E, 0x00, 0x1E, 0x00, 0x3E, 0x00, 0x7E, 0x00, 0x00,
        0xFF, 0xC2, 0x7F, 0xC0, 0x1F, 0xE0, 0x1F, 0xF0, 0x1F, 0xF2, 0x3F, 0xFE, 0x7F, 0xFE, 0xFF, 0x00,
    ]))
    ...
    #set population goal
    if world.options.goal == "population":
    ...
    if world.options.goal == "death_heim":
