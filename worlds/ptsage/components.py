...
def run_client(*args: str) -> None:
    ...
    from .client.launch import launch_ptsage_Client
    ...
    launch(launch_ptsage_Client, name="Pizza Tower SAGE Demo Client", args=args)
...
components.append(
    Component(
        "Pizza Tower SAGE Demo Client",
        func=run_client,
        game_name="Pizza Tower SAGE Demo",
