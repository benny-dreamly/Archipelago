...
from . import options as sage_options  # rename due to a name conflict with World.options
...
class SAGEWorld(World):
    """
    Pizza Tower Sage Demo is a short 4 level demo made for the 2019 Sonic Amateur Games Expo.
    This demo features a much different set of controls and level design than the final game.
    """
    ...
    options_dataclass = sage_options.SAGEOptions
    options: sage_options.SAGEOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    origin_region_name = "Snick Amateur Games Expo"
    ...
    def create_item(self, name: str) -> items.SAGEItem:
