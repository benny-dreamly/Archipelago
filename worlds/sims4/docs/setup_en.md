...
- Open the Archipelago Launcher and run the client. It should be called `The Sims 4 Client`. Upon the first time opening the client, it will prompt you to select your Mods folder. <b>ONLY SELECT THE MODS FOLDER LOCATED AT <code>(your sims folder, typically called The Sims 4)/Mods</code></b>
